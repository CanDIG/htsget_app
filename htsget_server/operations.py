...
DRS_URL = os.get("DRS_PATH") if os.get("DRS_PATH") else config['paths']['DRSPath']
MINIO_END_POINT = os.get("MINIO_URL") if os.get("MINIO_URL") else config['minio']['EndPoint']
MINIO_ACCESS_KEY = os.getenv("MINIO_ACCESS_KEY") if os.getenv("MINIO_ACCESS_KEY") else config['minio']['AccessKey']
MINIO_SECRET_KEY = os.getenv("MINIO_SECRET_KEY") if os.getenv("MINIO_SECRET_KEY") else config['minio']['SecretKey']
